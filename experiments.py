...
from Train_Ours import ClassifierTrainer
...
def cnn_experiment(
    ...
    **kw,
    ...
    fit_res = None
    # ====== YOUR CODE: ======
    channels = [filter_value for filter_value in filters_per_layer for _ in range(layers_per_block)]
    model = model_cls(
